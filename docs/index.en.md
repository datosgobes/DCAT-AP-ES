...
!!! warning "Conventions Guide"
    As additional material to this technical guide, the [**datos.gob.es Conventions**](conventions.en.md) are included. These establish **specific conventions** where **additional rules** are defined to address practical, semantic, or technical needs in the application of DCAT-AP-ES that complement this formal specification.
